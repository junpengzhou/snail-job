...
`,[c("border",`
 ...
 `,[Q("& +",[c("content",{marginTop:"9px"})])]),c("content",{transition:"color .3s var(--n-bezier)",fontSize:"var(--n-font-size)"})]),c("icon",{transition:"color .3s var(--n-bezier)"})]),me=Object.assign(Object.assign({},E.props),{title:String,showIcon:{type:Boolean,default:!0},type:{type:String,default:"default"},bordered:{type:Boolean,default:!0},closable:Boolean,onClose:Function,onAfterLeave:Function,onAfterHide:Function}),xe=A({name:"Alert",inheritAttrs:!1,props:me,slots:Object,setup(n){const{mergedClsPrefixRef:e,mergedBorderedRef:a,inlineThemeDisabled:l,mergedRtlRef:t}=J(n),f=E("Alert","-alert",pe,Ce,n,e),I=U("Alert",t,e),h=S(()=>{const{common:{cubicBezierEaseInOut:s},self:o}=f.value,{fontSize:_,borderRadius:z,titleFontWeight:y,lineHeight:T,iconSize:H,iconMargin:P,iconMarginRtl:W,closeIconSize:k,closeBorderRadius:B,closeSize:j,closeMargin:L,closeMarginRtl:N,padding:F}=o,{type:u}=n,{left:O,right:V}=ee(P);return{"--n-bezier":s,"--n-color":o[g("color",u)],"--n-close-icon-size":k,"--n-close-border-radius":B,"--n-close-color-hover":o[g("closeColorHover",u)],"--n-close-color-pressed":o[g("closeColorPressed",u)],"--n-close-icon-color":o[g("closeIconColor",u)],"--n-close-icon-color-hover":o[g("closeIconColorHover",u)],"--n-close-icon-color-pressed":o[g("closeIconColorPressed",u)],"--n-icon-color":o[g("iconColor",u)],"--n-border":o[g("border",u)],"--n-title-text-color":o[g("titleTextColor",u)],"--n-content-text-color":o[g("contentTextColor",u)],"--n-line-height":T,"--n-border-radius":z,"--n-font-size":_,"--n-title-font-weight":y,"--n-icon-size":H,"--n-icon-margin":P,"--n-icon-margin-rtl":W,"--n-close-size":j,"--n-close-margin":L,"--n-close-margin-rtl":N,"--n-padding":F,"--n-icon-margin-left":O,"--n-icon-margin-right":V}}),r=l?oe("alert",S(()=>n.type[0]),h,n):void 0,d=re(!0),C=()=>{const{onAfterLeave:s,onAfterHide:o}=n;s&&s(),o&&o()};return{rtlEnabled:I,mergedClsPrefix:e,mergedBordered:a,visible:d,handleCloseClick:()=>{var s;Promise.resolve((s=n.onClose)===null||s===void 0?void 0:s.call(n)).then(o=>{o!==!1&&(d.value=!1)})},handleAfterLeave:()=>{C()},mergedTheme:f,cssVars:l?void 0:h,themeClass:r?.themeClass,onRender:r?.onRender}},render(){var n;return(n=this.onRender)===null||n===void 0||n.call(this),i(G,{onAfterLeave:this.handleAfterLeave},{default:()=>{const{mergedClsPrefix:e,$slots:a}=this,l={class:[`${e}-alert`,this.themeClass,this.closable&&`${e}-alert--closable`,this.showIcon&&`${e}-alert--show-icon`,!this.title&&this.closable&&`${e}-alert--right-adjust`,this.rtlEnabled&&`${e}-alert--rtl`],style:this.cssVars,role:"alert"};return this.visible?i("div",Object.assign({},X(this.$attrs,l)),this.closable&&i(Y,{clsPrefix:e,class:`${e}-alert__close`,onClick:this.handleCloseClick}),this.bordered&&i("div",{class:`${e}-alert__border`}),this.showIcon&&i("div",{class:`${e}-alert__icon`,"aria-hidden":"true"},Z(a.icon,()=>[i(ne,{clsPrefix:e},{default:()=>{switch(this.type){case"success":return i(ie,null);case"info":return i(le,null);case"warning":return i(se,null);case"error":return i(te,null);default:return null}}})])),i("div",{class:[`${e}-alert-body`,this.mergedBordered&&`${e}-alert-body--bordered`]},q(a.header,t=>{const f=t||this.title;return f?i("div",{class:`${e}-alert-body__title`},f):null}),a.default&&i("div",{class:`${e}-alert-body__content`},a))):null}})}}),Ie={class:"color-warning font-500"},_e=A({__name:"delete-alert",setup(n){const e=ae(),a=ce(),l=e.name,t=S(()=>l==="job_task"?"删除前请检查待删除定时任务是存在通知配置或者工作流任务；":l==="retry_scene"?"删除前请检查待删除重试场景是存在通知配置或者重试任务；":l==="workflow_task"?"删除前请检查待删除工作流任务是存在通知配置；":l==="notify_recipient"?"删除前请检查通知配置是存在关联通知人；":null),f=S(()=>a.getDeleteAlert(l)!==!1),I=()=>(a.setDeleteAlert(l,!1),!0);return(h,r)=>{const d=xe;return f.value?(ge(),de(d,{key:0,"show-icon":!1,type:"warning",closable:"",onClose:I},{default:fe(()=>[R("div",Ie,[$(" 📢 "+he(t.value)+"该删除为 ",1),r[0]||(r[0]=R("span",{class:"color-error font-600"},"物理删除",-1)),r[1]||(r[1]=$(" ，删除后不可恢复，必要时可以先导出备份 "))])]),_:1})):ue("",!0)}}}),ye=be(_e,[["__scopeId","data-v-693376d1"]]);export{ye as _};
